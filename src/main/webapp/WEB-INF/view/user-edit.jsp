...
<html>
    <head>
        ...
        <style>
            ...
            button.delete {
	            display: block;
			    margin: 0 auto; /* see this will centers the button horizontally rishab*/
			    padding: 10px;
    ...
    <body>
        <header id="header">
            ...
            <h2 style="color: white;">Update Account Detail's:</h2>
        ...
        <button class="delete" onclick="confirmUserDelete('${user.uname}')">Delete ${user.uname} Account</button>
